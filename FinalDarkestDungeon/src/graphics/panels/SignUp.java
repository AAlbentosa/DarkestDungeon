...
public class SignUp extends JPanel{
	...
	public SignUp() {
			...
			signInButton.setBounds(303, 11, 97, 31);
			panel.add(signInButton);
			signInButton.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 16));
			signInButton.setForeground(new Color(0, 51, 204));
